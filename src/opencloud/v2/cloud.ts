...
const UserNotification_Payload = z.object({
  ...
  messageId: z.string(),
  parameters: z.record(UserNotification_Payload_ParameterValue),
 ...
 * @description Gets the specified entry.
 ...
 `/v2/universes/1234/data-stores/5678/entries/my-entry@latest:2024-12-02T06:00:00Z`.
 */
...
/**
 * @api GET https://apis.roblox.com/cloud/cloud/v2/universes/:universe_id/places/:place_id/luau-execution-session-tasks/:luau_execution_session_task_id/logs
 * @summary List Luau Execution Session Task Logs
 * @param universe_id The universe ID.
 * @param place_id The place ID.
 * @param luau_execution_session_task_id The luau-execution-session-task ID.
 ...
 */
export const getCloudV2UniversesUniverseIdPlacesPlaceIdLuauExecutionSessionTasksLuauExecutionSessionTaskIdLogs =
  endpoint({
    method: 'GET',
    path: '/cloud/v2/universes/:universe_id/places/:place_id/luau-execution-session-tasks/:luau_execution_session_task_id/logs',
    baseUrl: 'https://apis.roblox.com/cloud',
    requestFormat: 'json',
    serializationMethod: {
      universe_id: {},
      place_id: {},
      luau_execution_session_task_id: {},
      maxPageSize: {},
      pageToken: {},
      view: {},
    },
    parameters: {
      universe_id: z.string(),
      place_id: z.string(),
      luau_execution_session_task_id: z.string(),
      maxPageSize: z.number().int().optional(),
      pageToken: z.string().optional(),
...
/**
 * @api GET https://apis.roblox.com/cloud/cloud/v2/universes/:universe_id/places/:place_id/luau-execution-sessions/:luau_execution_session_id/tasks/:task_id
 ...
 * 45 calls per minute per API key owner or IP address
 */
export const getCloudV2UniversesUniverseIdPlacesPlaceIdLuauExecutionSessionsLuauExecutionSessionIdTasksTaskId =
  endpoint({
    method: 'GET',
    path: '/cloud/v2/universes/:universe_id/places/:place_id/luau-execution-sessions/:luau_execution_session_id/tasks/:task_id',
    baseUrl: 'https://apis.roblox.com/cloud',
    requestFormat: 'json',
    serializationMethod: {
      universe_id: {},
...
/**
 * @api GET https://apis.roblox.com/cloud/cloud/v2/universes/:universe_id/places/:place_id/luau-execution-sessions/:luau_execution_session_id/tasks/:task_id/logs
 * @summary List Luau Execution Session Task Logs
 * @param universe_id The universe ID.
 * @param place_id The place ID.
 * @param luau_execution_session_id The luau-execution-session ID.
 ...
 * 45 calls per minute per API key owner or IP address
 */
export const getCloudV2UniversesUniverseIdPlacesPlaceIdLuauExecutionSessionsLuauExecutionSessionIdTasksTaskIdLogs =
  endpoint({
    method: 'GET',
    path: '/cloud/v2/universes/:universe_id/places/:place_id/luau-execution-sessions/:luau_execution_session_id/tasks/:task_id/logs',
    baseUrl: 'https://apis.roblox.com/cloud',
    requestFormat: 'json',
    serializationMethod: {
      universe_id: {},
 ...
 * Only the `==` operator is available; no other operators nor
   built-ins are supported.
...
/**
 * @api GET https://apis.roblox.com/cloud/cloud/v2/universes/:universe_id/places/:place_id/versions/:version_id/luau-execution-session-tasks/:luau_execution_session_task_id/logs
 * @summary List Luau Execution Session Task Logs
 * @param universe_id The universe ID.
 * @param place_id The place ID.
 * @param version_id The version ID.
 ...
 * 45 calls per minute per API key owner or IP address
 */
export const getCloudV2UniversesUniverseIdPlacesPlaceIdVersionsVersionIdLuauExecutionSessionTasksLuauExecutionSessionTaskIdLogs =
  endpoint({
    method: 'GET',
    path: '/cloud/v2/universes/:universe_id/places/:place_id/versions/:version_id/luau-execution-session-tasks/:luau_execution_session_task_id/logs',
    baseUrl: 'https://apis.roblox.com/cloud',
    requestFormat: 'json',
    serializationMethod: {
      universe_id: {},
