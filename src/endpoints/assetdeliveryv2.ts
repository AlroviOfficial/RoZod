...
const Roblox_Web_Assets_IAssetItemError = z.object({ Code: z.number().int(), Message: z.string(), CustomErrorCode: z.union([z.literal(0), z.literal(1), z.literal(2), z.literal(3), z.literal(4)]) }).passthrough();
const Roblox_Web_Assets_IAssetResponseItemV2 = z.object({ Locations: z.array(Roblox_Web_Assets_AssetFormatLocation), Errors: z.array(Roblox_Web_Assets_IAssetItemError), RequestId: z.string(), IsHashDynamic: z.boolean(), IsCopyrightProtected: z.boolean(), IsArchived: z.boolean(), AssetTypeId: z.number().int() }).passthrough();
const Roblox_Web_Assets_IAssetResponseItem = z.object({ Location: z.string(), Errors: z.array(Roblox_Web_Assets_IAssetItemError), RequestId: z.string(), IsHashDynamic: z.boolean(), IsCopyrightProtected: z.boolean(), IsArchived: z.boolean() }).passthrough();
const Roblox_Web_Assets_BatchAssetRequestItem = z.object({ assetName: z.string(), assetType: z.string(), clientInsert: z.boolean(), placeId: z.number().int(), requestId: z.string(), scriptInsert: z.boolean(), serverPlaceId: z.number().int(), universeId: z.number().int(), accept: z.string(), encoding: z.string(), hash: z.string(), userAssetId: z.number().int(), assetId: z.number().int(), version: z.number().int(), assetVersionId: z.number().int(), modulePlaceId: z.number().int(), assetFormat: z.string(), "roblox-assetFormat": z.string() }).passthrough();
