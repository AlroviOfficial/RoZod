...
const Roblox_Catalog_Api_CatalogSearchDetailedResponseItemV2 = z.object({
  ...
  discountInformation: Roblox_Catalog_Api_DiscountInformation,
  license: Roblox_Catalog_Api_CollectibleLicense,
  id: z.number().int(),
...
const Patch_BundleItemDetailModel = z.object({
  owned: z.boolean(),
  id: z.number().int(),
  name: z.string(),
  type: z.string(),
...
const Patch_CatalogSearchDetailedResponseItem = z.object({
  id: z.number().int(),
  itemType: z.enum(['Asset', 'Bundle']),
  assetType: z.union([
    z.literal(1),
  ...
  description: z.string(),
  productId: z.number().int(),
  bundledItems: z.array(Patch_BundleItemDetailModel),
  itemStatus: z.array(z.union([z.literal(1), z.literal(2), z.literal(7), z.literal(8)])),
  itemRestrictions: z.array(
    z.union([
      z.literal(1),
...
const Patch_ApiPageResponse_CatalogSearchDetailedResponseItem = z.object({
  previousPageCursor: z.string(),
  nextPageCursor: z.string(),
  data: z.array(Patch_CatalogSearchDetailedResponseItem),
});
...
export const getAssetsAssetidBundles = endpoint({
  ...
  requestFormat: 'json',
  serializationMethod: {
    assetId: { style: 'simple' },
    'Roblox-Place-Id': { style: 'simple' },
    'Roblox-Game-Id': { style: 'simple' },
  ...
  response: Patch_ApiPageResponse_CatalogSearchDetailedResponseItem,
  errors: [
    { status: 400, description: `1: Invalid assetId\n4: Invalid Cursor.` },
    { status: 403, description: `7: User is unauthorized.` },
  ],
});
