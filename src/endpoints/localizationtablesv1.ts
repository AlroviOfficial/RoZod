...
const Roblox_Web_WebAPI_Models_ApiArrayResponse_Roblox_LocalizationTables_Api_Language_ =
  z.object({ data: z.array(Roblox_LocalizationTables_Api_Language) });
...
const Roblox_LocalizationTables_Api_UpdateTableContentsResponse = z.object({
  failedEntriesAndTranslations: z.array(
    Roblox_LocalizationTables_Api_FailedEntry
  ),
...
const Roblox_LocalizationTables_Api_RaiseEventForAutoScrapedEntriesCleanupRequest =
  z.object({ maxAgeForFlush: z.string() });
const Roblox_LocalizationTables_Api_GameAutolocalizationInformationResponse =
  z.object({
...
const Roblox_LocalizationTables_Api_GetTableEntriesTranslationHistoryResponse =
  z.object({
    tableId: z.string().uuid(),
    locale: z.string(),
    entries: z.array(
...
const Roblox_LocalizationTables_Api_IngestContentMetadataPlaceInformation =
  z.object({ placeId: z.number().int(), placeVersionNumber: z.number().int() });
const Roblox_LocalizationTables_Api_IngestContentMetadata = z.object({
  placeInformation:
    Roblox_LocalizationTables_Api_IngestContentMetadataPlaceInformation,
});
const Roblox_LocalizationTables_Api_IngestAutoScrapedContentForGameRequest =
  z.object({
...
const Roblox_LocalizationTables_Api_SetAutolocalizationSettingsForGameRequest =
  z.object({
    isAutolocalizationEnabled: z.boolean(),
    isAutomaticEntriesSettingEnabled: z.boolean(),
...
export const postLocalizationTableTablesTableidEntriesTranslationFeedback =
  endpoint({
    ...
    response:
      Roblox_LocalizationTables_Api_GetTableEntriesTranslationFeedbackResponse,
    errors: [
      {
        status: 400,
        description: `3: Invalid table id.
...
export const postLocalizationTableTablesTableidEntriesTranslationHistory =
  endpoint({
    ...
    response:
      Roblox_LocalizationTables_Api_GetTableEntriesTranslationHistoryResponse,
    errors: [
      {
        status: 400,
        description: `3: Invalid table id.
